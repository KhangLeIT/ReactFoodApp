                    ...
                    {orders.sort(
                        ...
                        return (
                            <View style={styles.order} key={index}>
                                            ...
                                            <View style={styles.rowout}>
                                                <View style={styles.row}>
                                                    <View style={styles.left}>
                                                        ...
                                                        <Text style={styles.title}>{(item.data.foodName && item.data.foodName.length > 18)
                                                            ? `${item.data.foodName.substring(0, 18)}...`
                                                            : item.data.foodName}</Text>
                                                        
                                                    </View>
                                                    <Text style={styles.price1}>{formatVND(parseFloat(item.data.foodPrice))}đ</Text>
                                                    <View style={styles.right}>
                                                        <Text style={styles.totalprice}>{formatVND(parseInt(item.Foodquantity) * parseInt(item.data.foodPrice))}</Text>
                                                    </View>
                                                </View>
                                                ...
                                                <View style={styles.row}>
                                                    <View style={styles.left}>
                                                        ...
                                                        <Text style={styles.price1}>{formatVND(parseFloat(item.data.foodAddonPrice))}đ</Text>
                                                    </View>
                                                    <View style={styles.right}>
                                                        <Text style={styles.totalprice}>{formatVND(parseInt(item.Addonquantity) * parseInt(item.data.foodAddonPrice))}</Text>
                                                    </View>
                                                </View>
                                            </View>
                                        )
                                ...
                                <Text style={styles.total}>Total: {formatVND(parseFloat(order.ordercost))} đ</Text>
                                {
