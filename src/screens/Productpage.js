            ...
            <View style={styles.container1}>
                ...
                <View style={styles.s2}>
                    <View style={styles.s2in}>
                        ...
                        <Text style={styles.head2}>{formatVND(parseFloat(data.foodPrice))} đ</Text>
                    </View>
                    ...
                    {data.foodAddonPrice && <View style={styles.container3}>
                        ...
                        <View style={styles.c3in}>
                            <Text style={styles.text4}>{formatVND(parseFloat(data.foodAddon))}</Text>
                            <Text style={styles.text4}>{formatVND(parseFloat(data.foodAddonPrice))} đ</Text>
                        </View>
                    ...
                    <View style={styles.container3}>
                        ...
                        <View style={styles.c4in}>
                            ...
                            {data.foodAddonPrice ?
                                <Text style={styles.txt3}>{formatVND(
                                ...
                                <Text style={styles.txt3}>{
                                   formatVND(((parseInt(data.foodPrice) * parseInt(quantity))))
                                }đ</Text>
                            }
                        </View>
